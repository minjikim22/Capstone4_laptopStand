...
#################민지 수정#########################
  ...
  rect_ctr_point = _normalized_to_pixel_coordinates(
      relative_bounding_box.xmin + relative_bounding_box.width/2,
      relative_bounding_box.ymin + relative_bounding_box.height/2, image_cols,
      image_rows)
  return height, rect_ctr_point
